...
- [8. Maintain a security baseline](0008-security-baseline.md) — _Accepted_
  ...
  Related: [14. Backend service conventions](0014-service-conventions.md)
...
- [9. Build JVM projects with Gradle](0009-jvm-build-with-gradle.md) — _Accepted_
  ...
  Related: [10. Enforce JVM quality gates and layered tests](0010-jvm-quality-and-tests.md), [11. Kotlin language conventions](0011-kotlin-conventions.md)
- [10. Enforce JVM quality gates and layered tests](0010-jvm-quality-and-tests.md) — _Accepted_
  ...
  Related: [9. Build JVM projects with Gradle](0009-jvm-build-with-gradle.md), [11. Kotlin language conventions](0011-kotlin-conventions.md), [5. Make CI the merge gate](0005-ci-is-the-merge-gate.md)
- [11. Kotlin language conventions](0011-kotlin-conventions.md) — _Accepted_
  Kotlin builds on the shared JVM baseline (Gradle, Spotless, JaCoCo, layered tests) but has its own idioms and a native tooling ecosystem worth pinning so Kotlin repositories are consistent.
...
- [13. Spring Boot testing and operability](0013-spring-boot-testing-and-operability.md) — _Accepted_
  ...
  Related: [10. Enforce JVM quality gates and layered tests](0010-jvm-quality-and-tests.md), [12. Spring Boot application conventions](0012-spring-boot-conventions.md), [16. Observability in Spring Boot](0016-observability-in-spring-boot.md)
...
- [15. Observability baseline](0015-observability-baseline.md) — _Accepted_
  ...
  Related: [16. Observability in Spring Boot](0016-observability-in-spring-boot.md)

## Interaction

- [16. Observability in Spring Boot](0016-observability-in-spring-boot.md) — _Accepted_
