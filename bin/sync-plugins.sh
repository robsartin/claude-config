...
#
# Usage:
#   bin/sync-plugins.sh            # install new + update installed; report orphans
#   bin/sync-plugins.sh --prune    # also uninstall orphaned claude-config plugins
#   bin/sync-plugins.sh --dry-run  # print what would happen; change nothing
#
